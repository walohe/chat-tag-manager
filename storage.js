const DATABASE_NAME = 'SillyTavern-Chat-Tag-Manager-v1';
const DATABASE_VERSION = 1;
const STORE_NAME = 'records';

/**
 * IndexedDB 封装（结构借鉴参考项目的 storage.js）。
 * 记录主键 = userHandle + scopeKey + fileName 三重隔离；
 * 写操作通过 mutationTail 串行化，避免并发事务互相踩。
 */
